...
?>
<div class="order_top section-space">
  <img class="bg_order" src="/products/images/order/bg_order.png">
  <div class="container d-flex align-center">
    <div class="col-7">
      <h1 class="text-center uppercase">ORDER VASOMANIX</h1>
      <h2 class="bold position-relative uppercase mt-0 mb-30">Guaranteed Mind-blowing results!</h2>
      <p class="header_title">Remarkable results in 83% of users in just 2 weeks!</p>
    </div>
    <div class="col-5">
      ...
      <div class="container">
        <div id="stepShippingInfo" class="steps first step-1 pb-60">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group field-shippingaddress1 required">
                <label for="shippingaddress1"><span class="red">*</span> Shipping Address:</label>
            ...
            <div class="col-md-6">
              <div class="form-group field-shippingcity required">
                <label for="shippingcity"><span class="red">*</span> City</label>
            ...
            <div class="col-md-6">
              <div class="form-group field-shippingcountry required">
                <label for="shippingcountry"><span class="red">*</span> Country</label>
            ...
            <div class="col-md-6">
              <div class="row">
                <div class="form-group col-md-6 field-shippingstate required">
                  <label for="shippingstate"><span class="red">*</span> State / Province</label>
                  <div id="shippingStateContainer"></div>
                  <div class="help-block with-errors"></div>
                </div>
                <div class="form-group col-md-6 field-shippingzip required">
                  <label for="shippingzip"><span class="red">*</span> Zip Code:</label>
        ...
        <div id="stepPaymentOption" class="steps step-2 d-none pb-30">
          <div class="step_pane d-flex pb-30">
            <p class="title-2 bold">Step 2</p>
            <p class="header_title medium">Choose your payment</p>
          </div>
        ...
        <div id="stepCheckout" class="steps step-3 d-none">
          <div class="step_pane d-flex pb-30">
          ...
          <div id="creditCardInfo">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group cc-number required">
              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="expirationdate"><span class="red">*</span>  Expiration Date</label>
                    <div class="row">
                      <div class="form-group col-md-6 field-expirationdate required">
                      ...
                      <div class="form-group col-md-6 field-expirationyear required">
                  ...
                  <div class="form-group col-md-6 field-securitycode required">

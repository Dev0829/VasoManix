...
<div class="header">
  ...
  <div class="container">
    <div class="header-main pt-60 pb-60">
...
<div class="main-wrapper">
  <div class="wrapper-1">
    ...
    <div class="container section-space position-relative">
      <div class="information_pane">
        ...
        <img class="stars pt-15 pb-15" src="/products/images/stars.png">
      </div>
  ...
  <div class="wrapper-3 bg-white">
    <div class="item_section section-space">
      <div class="container">
        <div class="question_pane">
          <div class="image_part">
            <img src="/products/images/item_2.png">
          </div>
          <div class="description_part">
    ...
    <div class="item_section section-space bg-lightgrey">
      <div class="container">
        <div class="question_pane">
          <div class="image_part">
            <img src="/products/images/item_3.png">
          </div>
          <div class="description_part">
    ...
    <div class="item_section section-space">
      <div class="container">
        <div class="question_pane">
          <div class="image_part">
            <img src="/products/images/item_4.png">
          </div>
          <div class="description_part">
  ...
  <div class="wrapper-4">
    <img class="bg_result" src="/products/images/bg_result.png">
    <div class="container">
      <img class="real_man" src="/products/images/real_man.png">
      <img class="real_character" src="/products/images/real_character.png">
    </div>
  </div>
  <div class="wrapper-5 bg-white text-center">
    <div class="testimonial_pane bg-lightgrey pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/actor_3.png">
          <div class="badge_pane d-flex align-center">
            <img class="badge" src="/products/images/badge.png">
    ...
    <div class="testimonial_pane pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/actor_4.png">
          <div class="badge_pane d-flex align-center">
            <img class="badge" src="/products/images/badge.png">
            <p class="badge_text mb-15">Verified Customer</p>
          </div>
    ...
    <div class="testimonial_pane bg-lightgrey pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/actor_5.png">
          <div class="badge_pane d-flex align-center">
            <img class="badge" src="/products/images/badge.png">
            <p class="badge_text mb-15">Verified Customer</p>
          </div>
    ...
    <div class="testimonial_pane pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/actor_6.png">
          <div class="badge_pane d-flex align-center">
            <img class="badge" src="/products/images/badge.png">
            <p class="badge_text mb-15">Verified Customer</p>
          </div>
  ...
  <div class="wrapper-6 pt-30 pb-60">
    <img class="bg_trophy desktop-only" src="/products/images/bg_trophy.png">
    <img class="bg_trophy mobile-only" src="/products/images/bg_trophy_mobile.png">
    <div class="container">
      <div class="trophy_pane d-flex align-center">
        <img class="trophy desktop-only" src="/products/images/trophy.png">
        <img class="trophy mobile-only" src="/products/images/trophy_mobile.png">
  ...
  <div class="wrapper-8 pb-60">
    <img class="bg_effect8 desktop-only" src="/products/images/bg_effect8.png">
    <img class="bg_effect8 mobile-only" src="/products/images/bg_effect8_mobile.png">
    <img class="bg_document desktop-only" src="/products/images/bg_document.png">
    <img class="bg_document mobile-only" src="/products/images/bg_document_mobile.png">
    <div class="container">
      ...
      <div class="document_pane d-flex pt-120">
        ...
        <img class="research" src="/products/images/research.png">
      </div>
      ...
      <div class="document_pane d-flex">
        ...
        <img class="research" src="/products/images/actor_7.png">
      </div>
  ...
  <div class="wrapper-9 section-space">
    <img class="bg_wrapper9" src="/products/images/bg_wrapper9.png">
  ...
  <div class="wrapper-10">
    <img class="bg_table" src="/products/images/bg_table.png">
    <img class="d-flex mobile-only table" src="/products/images/table_mobile.png">
    <div class="container pt-30 pb-30">
      <img class="d-flex desktop-only table" src="/products/images/table.png">
    </div>
  </div>
  <div class="wrapper-11 text-center bg-lightgrey">
    <img class="bg_source desktop-only" src="/products/images/bg_source.png">
    <img class="bg_source mobile-only" src="/products/images/bg_source_mobile.png">
    <div class="source_des container pt-60 pb-60 text-center white">
      ...
      <p class="title">Superior Male features the best performing natural ingredients to give you the SIZE, STAMINA, and SEX DRIVE you need to experience the BIGGEST and HARDEST erections.</p>
    </div>
    <div class="testimonial_pane mobile-space pt-120 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_1.png">
        </div>
        <div class="description_part text-left">
          ...
          <p class="description mt-0">Horny Goat Weed is a therapeutic herb used in Traditional Chinese medicine as a treatment for poor erection quality and infertility. The herb itself is native to China, but it is now also found in some places in the Mediterranean and the Himalayas. Our research shows that Horny Goat Weed contains a potent erectogenic and sex drive booster called Icariin, which can only be obtained by purifying the roots of the herb. Superior Male contains the highest purification of Horny Goat Weed, with the highest concentrations of Icariin to maximize sex drive, stamina, and penis size. </p>
        </div>
      </div>
    </div>
    <div class="testimonial_pane bg-grey pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_2.png">
        </div>
        <div class="description_part text-left">
    ...
    <div class="testimonial_pane pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_3.png">
        </div>
        <div class="description_part text-left">
    ...
    <div class="testimonial_pane bg-grey pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_4.png">
        </div>
        <div class="description_part text-left">
    ...
    <div class="testimonial_pane pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_5.png">
        </div>
        <div class="description_part text-left">
    ...
    <div class="testimonial_pane bg-grey pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_6.png">
        </div>
        <div class="description_part text-left">
    ...
    <div class="testimonial_pane pt-60 pb-60">
      <div class="container d-flex align-center">
        <div class="image_part d-flex">
          <img src="/products/images/source_7.png">
        </div>
        <div class="description_part text-left">
    ...
    <div class="container pt-60 pb-60 text-center">
      ...
      <div class="pro_section section-space">
        ...
        <div class="pro_right_section">
          <div class="pro_pane">
            <img class="pro_img" src="/products/images/pro_92.png">
            <p class="description bold">OF MEN EXPERIENCE <span class="red">LARGER </span> ERECTIONS WITHIN 14 DAYS</p>
          </div>
          <div class="pro_pane">
            <img class="pro_img" src="/products/images/pro_90.png">
  ...
  <div class="wrapper-13">
    <img class="bg_wrapper13" src="/products/images/bg_wrapper13.png">
    <div class="container">
      <div class="effect_pane d-flex align-center white">
        ...
        <img class="bottle_twice desktop-only" src="/products/images/bottle_twice.png">
        <img class="bottle_twice mobile-only" src="/products/images/bottle_twice_mobile.png">
      </div>
    </div>
  </div>
  ...
  <div class="wrapper-15 section-space bg-lightgrey">
    <div class="tile_pane">
      <img class="bg_tile" src="/products/images/bg_tile.png">
    </div>

...
<div class="wrapper-4 section-space white">
  <img class="bg_wrapper4" src="/products/images/bg_wrapper4.png">
  <div class="container d-flex">
    <div class="col-5">
      <h2 class="text-left">THE FIRST AND ONLY PROVEN PENIS ENLARGEMENT FORMULA GUARANTEED TO:</h2>
      <div class="grid-wrapper">
        <div class="grid_pane">
          <img class="check" src="/products/images/check.png">
          <p class="grid_des">Increase penis length and thickness</p>
        </div>
        <div class="grid_pane">
          <img class="check" src="/products/images/check.png">
          <p class="grid_des">Maximize sex drive and energy</p>
        </div>
        <div class="grid_pane">
          <img class="check" src="/products/images/check.png">
          <p class="grid_des">Boost sexual performance and stamina</p>
        </div>
        <div class="grid_pane">
          <img class="check" src="/products/images/check.png">
          <p class="grid_des">Boost semen volume</p>
        </div>
        <div class="grid_pane">
          <img class="check" src="/products/images/check.png">
